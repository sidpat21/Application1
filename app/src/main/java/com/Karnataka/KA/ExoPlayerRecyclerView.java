...
import com.Karnataka.KA.MediaObject;
...
public class ExoPlayerRecyclerView extends RecyclerView {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if (!isEndOfList) {
            int startPosition = 0;
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
                startPosition = ((LinearLayoutManager) Objects.requireNonNull(
        ...
        int currentPosition =
                0;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            currentPosition = targetPosition - ((LinearLayoutManager) Objects.requireNonNull(
                    getLayoutManager())).findFirstVisibleItemPosition();
        }
    ...
    private int getVisibleVideoSurfaceHeight(int playPosition) {
        int at = 0;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            at = playPosition - ((LinearLayoutManager) Objects.requireNonNull(
                    getLayoutManager())).findFirstVisibleItemPosition();
        }
